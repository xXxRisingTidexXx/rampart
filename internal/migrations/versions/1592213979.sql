...
(
    ...
    industrial_zone_distance real                  not null check ( industrial_zone_distance = -1 or 0 <= industrial_zone_distance ),
    green_zone_distance      real                  not null check ( green_zone_distance = -1 or 0 <= green_zone_distance ),
