...
(
    ...
    subway_station_distance  real                  not null default -1 check ( subway_station_distance = -1 or 0 <= subway_station_distance ),
    industrial_zone_distance real                  not null default -1 check ( industrial_zone_distance = -1 or 0 <= industrial_zone_distance ),
    green_zone_distance      real                  not null default -1 check ( green_zone_distance = -1 or 0 <= green_zone_distance ),
