...
(
    ...
    state_sanitization_number          smallint           not null check ( 0 <= state_sanitization_number ),
    city_sanitization_number           smallint           not null check ( 0 <= city_sanitization_number ),
    district_sanitization_number       smallint           not null check ( 0 <= district_sanitization_number ),
    swap_sanitization_number           smallint           not null check ( 0 <= swap_sanitization_number ),
    street_sanitization_number         smallint           not null check ( 0 <= street_sanitization_number ),
    house_number_sanitization_number   smallint           not null check ( 0 <= house_number_sanitization_number ),
