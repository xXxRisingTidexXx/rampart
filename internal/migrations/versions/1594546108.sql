...
(
    ...
    absent_subway_gauging_number           smallint           not null check ( 0 <= absent_subway_gauging_number ),
    failed_subway_gauging_number           smallint           not null check ( 0 <= failed_subway_gauging_number ),
    inconclusive_subway_gauging_number     smallint           not null check ( 0 <= inconclusive_subway_gauging_number ),
    successful_subway_gauging_number       smallint           not null check ( 0 <= successful_subway_gauging_number ),
    failed_industrial_gauging_number       smallint           not null check ( 0 <= failed_industrial_gauging_number ),
    inconclusive_industrial_gauging_number smallint           not null check ( 0 <= inconclusive_industrial_gauging_number ),
    successful_industrial_gauging_number   smallint           not null check ( 0 <= successful_industrial_gauging_number ),
    failed_green_gauging_number            smallint           not null check ( 0 <= failed_green_gauging_number ),
    inconclusive_green_gauging_number      smallint           not null check ( 0 <= inconclusive_green_gauging_number ),
    successful_green_gauging_number        smallint           not null check ( 0 <= successful_green_gauging_number ),
    ...
    subway_gauging_duration                real               not null check ( 0 <= subway_gauging_duration ),
    industrial_gauging_duration            real               not null check ( 0 <= industrial_gauging_duration ),
    green_gauging_duration                 real               not null check ( 0 <= green_gauging_duration ),
